...
const ModalTitle=styled.div`
  ...
  font-family: 'Avenir,-apple-system,BlinkMacSystemFont,"Microsoft YaHei","Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji"',serif;
  font-weight: 600;
  font-size: 1.2rem;
  padding-bottom: 10px;
...
const SettingIcon=()=>{
  return(
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 48' width='32px' height='32px' style={{'margin':'0 6px'}}>
